...
{
    [TestClass]
    public class InsertOnKeysConflictReplaceGeneratorTests
    {
        [TestMethod]
        public void Test()
        {
            ...
            InsertOnKeysConflictReplaceGenerator gen = new(updateGen);
            ...
            Assert.AreEqual("INSERT INTO test_schema.test_table (id, test_col) VALUES (1, 'newValue') ON CONFLICT (id) DO UPDATE SET test_col = EXCLUDED.test_col;",
                sql);
        }
    }
}
